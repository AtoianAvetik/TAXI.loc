...
class FW_Option_Type_Form_Builder_Item_Iconed_Checkboxes extends FW_Option_Type_Form_Builder_Item {
	public function get_type() {
		return 'iconed-checkboxes';
	}
	...
	public function enqueue_static() {
        $uri = fw_get_template_customizations_directory_uri('/extensions/forms/includes/builder-items/iconed-checkboxes/static');
...
FW_Option_Type_Builder::register_item_type( 'FW_Option_Type_Form_Builder_Item_Iconed_Checkboxes' );
