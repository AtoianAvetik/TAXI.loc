fwEvents.on('fw-builder:' + 'form-builder' + ':register-items', function (builder) {
    var currentItemType = 'iconed-checkboxes';

    var localized = window['fw_form_builder_item_type_iconed_checkboxes'];
                            ...
                            '<div class="fw-form-item-preview-choices-list">' +
                                '<% _.each(choices, function(choice, i){ %>' +
                                    '<p class="fw-form-item-preview-choice">' +
                                        '<input type="checkbox" <% if (choice.checked) { %>checked<% } %> onclick="return false;"> ' +
                                        '<i class="<%= choice["icon"]["icon-class-without-root"] %>"></i> ' +
