...
class FW_Option_Type_Form_Builder_Item_Time_Picker extends FW_Option_Type_Form_Builder_Item
{
    /**
     * The item type
     * @return string
    ...
    public function get_thumbnails()
    {
        return array(
            array(
                'html' =>
                    '<div class="item-type-icon-title" data-hover-tip="' . __( 'Add an Time picker field', 'samik' ) . '">'.
                    '    <div class="item-type-icon"><span class="dashicons dashicons-clock"></span></div>'.
                    '    <div class="item-type-title">'. __('Time', 'samik') .'</div>'.
                    '</div>',
            )
        );
    }
    ...
    {
        $uri = fw_get_template_customizations_directory_uri('/extensions/forms/includes/builder-items/time-picker/static');
        ...
        wp_localize_script(
            'fw-builder-' . $this->get_builder_type() . '-item-' . $this->get_type(),
            'fw_form_builder_item_type_time_picker',
            array(
                'l10n' => array(
                    'item_title'        => __('Time', 'samik'),
    ...
    public function frontend_render(array $item, $input_value)
    {
        ...
        return fw_render_view(
            $this->locate_path(
                // Search view in 'framework-customizations/extensions/forms/form-builder/items/time-picker/views/view.php'
                '/views/view.php',
...
FW_Option_Type_Builder::register_item_type('FW_Option_Type_Form_Builder_Item_Time_Picker');