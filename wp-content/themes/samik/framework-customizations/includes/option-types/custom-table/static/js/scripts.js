( function ($) {
    $(document).ready(function () {
        ...
        function FwTableBuilder($tableBuilder) {
            ...
            var _self = this,
                tableBuilderId = $tableBuilder.attr('id'),
            ...
            var process = {
                ...
                getAllowedCols: function(){
                    var $viewChooser = $tableBuilder.find('#' + tableBuilderId  + '-header-optionstable_purpose'),
                ...
                tableBuilderEvents: function () {
                    ...
                    $tableBuilder.find('#' + tableBuilderId  + '-header-optionstable_purpose').on('change', process.updateTable);
        ...
        fwEvents.on('fw:options:init', function (data) {
            data.$elements.find('.fw-option-type-custom-table:not(.fw-option-initialized)').each(function () {
