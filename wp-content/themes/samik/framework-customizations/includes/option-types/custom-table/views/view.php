...
<?php $header_cell_template = fw_get_template_customizations_directory('/includes/option-types/custom-table/views/cell-head-template.php'); ?>
<?php $worksheet_cell_template = fw_get_template_customizations_directory('/includes/option-types/custom-table/views/cell-worksheet-template.php'); ?>
